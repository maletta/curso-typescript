...
var form = document.documentElement.querySelector('.form');
var username = document.documentElement.querySelector('.username');
var email = document.documentElement.querySelector('.email');
var password = document.documentElement.querySelector('.password');
var password2 = document.documentElement.querySelector('.password2 ');
...
function shouldSendForm(form) {
    var sendForm = true;
    var inputsWithErrors = form.querySelectorAll("." + SHOW_ERROR_MESSAGE).length;
...
// instalando lib que valida com expressões regulares
// yarn add validator
// instalando tipos da lib, ou chamado de declarations files
