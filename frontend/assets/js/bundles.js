...
const form = document.documentElement.querySelector('.form');
const username = document.documentElement.querySelector('.username');
const email = document.documentElement.querySelector('.email');
const password = document.documentElement.querySelector('.password');
const password2 = document.documentElement.querySelector('.password2 ');
...
function shouldSendForm(form) {
    let sendForm = true;
    const inputsWithErrors = form.querySelectorAll(`.${SHOW_ERROR_MESSAGE}`).length;
